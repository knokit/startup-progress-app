    ...
    <div className="card">
      ...
      <ol className="list-ordered-circle">
        {stages.map((stage, index) => {
          const isPrevStageCompleted = index === 0 || isStageCompleted(stages[index - 1], completedIds);
          const isNextStageCompleted = index < stages.length - 1 && isStageCompleted(stages[index + 1], completedIds);
            ...
            >
              {getStageTasks(stage).map((task) => (
                <Task
                  ...
                  isDisabled={isAllCompleted || !isPrevStageCompleted || isNextStageCompleted}
